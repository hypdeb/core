...
public interface IOption<out T> : IReadOnlyList<T>
{
    ...
    /// <summary>
    /// Maps the option in one of two ways -- <paramref name="some" /> or <paramref name="none" /> -- depending on whether the
    /// option has a value or not respectively.
    /// </summary>
    ...
    /// <summary>
    /// Returns a value indicating whether or not the <see cref="IOption{T}" /> has a value, and this value satisfies the
    ...
    /// <summary>
    /// Returns a value indicating whether or not the <see cref="IOption{T}" /> doesn't have a value, or the value satisfies
    ...
    /// <summary>
    /// Performs the <paramref name="some" /> if the <see cref="IOption{T}" /> has a value, otherwise performs
    /// <paramref name="none" />.
    /// </summary>
