...
public static class Functions
{
    ...
    public static T If<T>(bool condition, Func<T> ifBranch, Func<T> elseBranch) => condition ? ifBranch() : elseBranch();
    ...
    public static Lazy<T> Lazy<T>(Func<T> func, LazyThreadSafetyMode lazyThreadSafetyMode = LazyThreadSafetyMode.ExecutionAndPublication) =>
        new(func, lazyThreadSafetyMode);
}