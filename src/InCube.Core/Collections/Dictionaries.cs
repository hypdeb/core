...
public static class Dictionaries
{
    ...
    public static TV GetOrDefault<TK, TV>(this IReadOnlyDictionary<TK, TV> self, TK key, TV @default) =>
        ...
        where TK : notnull
    {
        ...
        return dict is SortedDictionary<TK, TV> sorted && sorted.Comparer == comparer
            ? sorted
