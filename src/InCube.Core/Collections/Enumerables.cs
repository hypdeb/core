...
public static class Enumerables
{
    ...
    /// <summary>
    /// Joins the strings in the enumerable with the specified separator (default: ", "), wrapped by with a string in the
    ...
    /// <summary>
    /// Gets the maximum element of an enumerable by its elements using a projection to comparable elements and provided
    ...
    /// <summary>
    /// Gets the minimum element of an enumerable by its elements using a projection to comparable elements and provided
    /// <see cref="IComparer{T}" />.
    /// </summary>
    /// <typeparam name="TSource">The type of the source enumerable.</typeparam>
    /// <typeparam name="TComparable">The projection producing a comparable result.</typeparam>
    ...
    public static (IEnumerable<T> Left, IEnumerable<T> Right) Split<T>(this IEnumerable<T> self, Func<T, bool> isLeft)
    {
        ...
        return (groups.GetOption(true).GetValueOrDefault(Enumerable.Empty<T>()), groups.GetOption(false).GetValueOrDefault(Enumerable.Empty<T>()));
    }
    ...
    /// A function projecting each item to a value used for determining whether an item is present in
    /// both sets.
    /// </param>
